...
int main() {
    ...
    command_Map["3"] = &Queue_class::pop_front;
    command_Map["4"] = &Queue_class::pop_back;
    command_Map["5"] = &Queue_class::size;
    command_Map["6"] = &Queue_class::empty;
    command_Map["7"] = &Queue_class::front;
    command_Map["8"] = &Queue_class::back;
